...
export default {
  ...
  mounted () {
    ...
    setTimeout(function () {
      that.someList = [
        {
          imgurl: "../../assets/image/img/1.png"
        },
        {
          imgurl: "../../assets/image/img/2.png"
        },
        {
          imgurl: "../../assets/image/img/3.png"
        },
        {
          imgurl: "../../assets/image/img/4.png"
        },
        {
          imgurl: "../../assets/image/img/5.png"
        },
        {
          imgurl: "../../assets/image/img/6.png"
        },
        {
          imgurl: "../../assets/image/img/7.png"
        }
      ]
    }, 2000)
  },
